    ...
    >
      <div className="editorial-container">
        ...
        <div className="grid lg:grid-cols-12 gap-14 lg:gap-20">
          <MobileReveal className="lg:col-span-4 space-y-12" delay={0.08}>
          ...
          <div className="lg:col-span-8">
            ...
            <MobileStagger className="grid sm:grid-cols-2 gap-10" stagger={0.08}>
              {skillGroups.map((group) => (
                <MobileStaggerItem key={group.label}>
